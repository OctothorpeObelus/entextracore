...
E2Helper.Descriptions["childrenIDs"] = "Returns the creation IDs of this entity's children as a key-value pair. Unlike E:id(), it will always increase and old values won't be reused."
